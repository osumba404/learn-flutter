...
import 'package:currency_converter/curency_converter_cupertiono_page.dart';
...
void main() {
  runApp(const MyCupertinoApp()); //adding const says the widget MyApp does not need to ba created every time
}
